...
const statuses = [
  { label: "Backlog", icon: <CircleDashed className="w-4 h-4 text-red-500" /> },
  { label: "Planned", icon: <Circle className="w-4 h-4 text-gray-500" /> },
  {
    label: "In Progress",
    icon: <Loader className="w-4 h-4 text-yellow-500" />,
  },
  {
    label: "Completed",
      ...
      <div ref={ref} className="relative inline-block text-left">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            {statuses.find((s) => s.label === value)?.label || "Backlog"}
          </div>
        </button>
